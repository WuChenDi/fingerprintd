...
**[架构](#架构)** — 1 背景 · 2 目标与威胁模型 · 3 成功指标 ·
4 架构:挑战-响应 + 服务端融合 · 5 HTTP 接口 · 6 数据模型 · 7 隐私与合规 ·
8 部署目标 · 9 纵深防御控制

**[模糊匹配](#模糊匹配)** — 1 问题定义 · 2 分量分类 · 3 存储表示 ·
4 阶段一:候选集生成 · 5 阶段二:概率打分(Fellegi–Sunter) · 6 confidence 输出 ·
7 漂移与投毒防护 · 8 边界情况 · 9 参数估计与冷启动 · 10 离线评估 ·
11 数据结构与性能 · 12 待解决问题
